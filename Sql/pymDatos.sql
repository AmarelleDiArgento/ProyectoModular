...
-- PRODUCT INSERT
-- ------------------------------------------------------------
call proyectomodular.productins('101', 'AREPA MAIZ CUAJADA', '2400', 3, 'assets/logoprobocaitos.png', 1);
call proyectomodular.productins('102', 'AREPA MAIZ BOCADILLO', '2400', 3, 'assets/logoprobocaitos.png', 1);
call proyectomodular.productins('103', 'AREPA MAIZ QUESO', '2600', 3, 'assets/logoprobocaitos.png', 1);
call proyectomodular.productins('104', 'AREPA MAIZ - POLLO', '2600', 3, 'assets/logoprobocaitos.png', 1);
call proyectomodular.productins('105', 'AREPA MAIZ CARNE', '2600', 3, 'assets/logoprobocaitos.png', 1);
call proyectomodular.productins('106', 'AREPA MAIZ AREQUIPE', '2600', 3, 'assets/logoprobocaitos.png', 1);
call proyectomodular.productins('107', 'AREPA MAIZ RANCHERA', '2600', 3, 'assets/logoprobocaitos.png', 1);
call proyectomodular.productins('301', 'ALMOJABANA', '2400', 9, 'assets/logoprobocaitos.png', 1);
call proyectomodular.productins('302', 'RESOBADO', '1700', 9, 'assets/logoprobocaitos.png', 1);
call proyectomodular.productins('303', 'CALENTANO', '1700', 9, 'assets/logoprobocaitos.png', 1);
call proyectomodular.productins('304', 'GARULLA', '2500', 3, 'assets/logoprobocaitos.png', 1);
call proyectomodular.productins('305', 'GARULLA CON AREQUIPE', '2600', 3, 'assets/logoprobocaitos.png', 1);
call proyectomodular.productins('401', 'AVENA', '2400', 7, 'assets/logoprobocaitos.png', 1);
call proyectomodular.productins('402', 'MASATO 09 ONZ', '1900', 7, 'assets/logoprobocaitos.png', 1);
call proyectomodular.productins('403', 'JUGO NATURAL EN AGUA', '3700', 7, 'assets/logoprobocaitos.png', 1);
call proyectomodular.productins('404', 'JUGO NATURAL EN LECHE', '4200', 7, 'assets/logoprobocaitos.png', 1);
call proyectomodular.productins('501', 'TE CHAI', '4400', 7, 'assets/logoprobocaitos.png', 1);
call proyectomodular.productins('508', 'AROMATICAS DE FRUTAS', '3200', 6, 'assets/logoprobocaitos.png', 1);
call proyectomodular.productins('510', 'MILO 9 ONZ', '3000', 6, 'assets/logoprobocaitos.png', 1);
call proyectomodular.productins('513', 'AGUADEPANELA', '1700', 6, 'assets/logoprobocaitos.png', 1);
call proyectomodular.productins('516', 'CAPUCHINO IRLANDES', '4500', 6, 'assets/logoprobocaitos.png', 1);
call proyectomodular.productins('518', 'AMERICANO 7 ONZAS', '1800', 6, 'assets/logoprobocaitos.png', 1);
call proyectomodular.productins('520', 'CAPPUCCINO TRADICIONAL 9 ONZAS', '3000', 6, 'assets/logoprobocaitos.png', 1);
call proyectomodular.productins('521', 'CAFÉ DE LA CASA 9 oz', '3000', 6, 'assets/logoprobocaitos.png', 1);
call proyectomodular.productins('712', 'PET 400 ML POSTOBON', '2600', 7, 'assets/logoprobocaitos.png', 1);
call proyectomodular.productins('715', 'HIT 8 ONZ NO RETORNABLE', '2200', 7, 'assets/logoprobocaitos.png', 1);
call proyectomodular.productins('721', 'AGUA', '2700', 7, 'assets/logoprobocaitos.png', 1);
call proyectomodular.productins('722', 'VITAL', '2200', 7, 'assets/logoprobocaitos.png', 1);
call proyectomodular.productins('727', 'H2Oh!', '3100', 7, 'assets/logoprobocaitos.png', 1);
call proyectomodular.productins('001', 'Opcion1', '8200', 1, 'assets/logoprobocaitos.png', 1);
call proyectomodular.productins('002', 'Opcion2', '12000', 1, 'assets/logoprobocaitos.png', 1);
call proyectomodular.productins('003', 'Opcion3', '9000', 1, 'assets/logoprobocaitos.png', 1);
call proyectomodular.productins('004', 'probocado1', '14900', 5, 'assets/logoprobocaitos.png', 1);
call proyectomodular.productins('005', 'probocado2', '15900', 5, 'assets/logoprobocaitos.png', 1);
call proyectomodular.productins('006', 'Campesinos', '4700', 2, 'assets/logoprobocaitos.png', 1);
call proyectomodular.productins('007', 'Rancheros', '5400', 2, 'assets/logoprobocaitos.png', 1);
call proyectomodular.productins('008', 'Del Huerto', '4700', 2, 'assets/logoprobocaitos.png', 1);
call proyectomodular.productins('009', 'Clasicos', '4100', 2, 'assets/logoprobocaitos.png', 1);
