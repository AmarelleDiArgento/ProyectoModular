...
CREATE TABLE IF NOT EXISTS proyectomodular.pod_user (
  ps_user_id VARCHAR(45) NOT NULL primary key,
...
CREATE TABLE IF NOT EXISTS proyectomodular.privilege (
  ...
  icon VARCHAR(75) NOT NULL UNIQUE,
  route VARCHAR(75) NOT NULL UNIQUE,
  status TINYINT(4) NOT NULL,  
  CONSTRAINT fk_privilege_module1 FOREIGN KEY (module_module_id) REFERENCES proyectomodular.module (module_id)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);
...
CREATE TABLE IF NOT EXISTS proyectomodular.product (
  ...
  CONSTRAINT fk_product_category1 FOREIGN KEY (category_id) REFERENCES proyectomodular.category (category_id)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT fk_product_tax1 FOREIGN KEY (tax_tax_id) REFERENCES proyectomodular.tax (tax_id)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);
...
CREATE TABLE IF NOT EXISTS proyectomodular.sale (
  ...
  CONSTRAINT fk_sale_user1 FOREIGN KEY (user_id) REFERENCES proyectomodular.user (user_id)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT fk_sale_user2 FOREIGN KEY (cliente_id) REFERENCES proyectomodular.user (user_id)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);
...
CREATE TABLE IF NOT EXISTS proyectomodular.sale_product (
  sp_product_id INT(11) PRIMARY KEY NOT NULL AUTO_INCREMENT,
...
INSERT INTO proyectomodular.timestamps
